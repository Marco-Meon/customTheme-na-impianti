...
<main class="grid">
  ...
  <?php if ( is_search() ) { // display serach title if is search page ?>
    ...
    <h1>
      <?php esc_html_e( 'Results for: ', 'nextframe'); // Display translated result text, escaped for security ?><?php echo $s; // display word of the search ?>
    </h1>
    ...
    <div clas="col-100"><?php esc_html_e('Sorry, no posts matched your criteria.', 'nextframe'); // dispaly no result message ?></div>
